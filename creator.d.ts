	...
	*/
	...
	export enum WrapMode {		
		...
		*/
		...
		Node also inherits from {{#crossLink "eventManager"}}Event Target{{/crossLink}}, it permits Node to dispatch events.
		For events supported by Node, please refer to {{#crossLink "Node.EventType"}}{{/crossLink}}
		!#zh
		Cocos Creator 场景中的所有节点类。节点也继承了 {{#crossLink "eventManager"}}eventManager{{/crossLink}}，它允许节点发送事件。<br/>
		...
		*/
		...
		/** !#en
		eventManager is an object to which an event is dispatched when something has occurred.
		...
		/** !#en
		Register an callback of a specific event type on the eventManager.
		...
		*/
		...
		The event target is the eventManager object upon which the dispatchEvent() method is called.
		!#zh 分发事件到事件流中。
		...
		*/
		...
		export class SystemEvent extends eventManager {	
	}		
